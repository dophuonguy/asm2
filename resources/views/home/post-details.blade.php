...
<body>
          ...
          <div class=" col-lg-8 mb-5 mb-lg-0">
            <article>
              <div class="post-slider mb-4">
                <img src="{{asset("assets")}}/images/post/post-10.jpg" class="card-img" alt="post-thumb">
                <img src="{{asset("assets")}}/images/post/post-1.jpg" class="card-img" alt="post-thumb">
              </div>
  ...
  <span style="color:#66d9ef">print</span> s
                ...
                <p><img src="{{asset("assets")}}/images/post/post-4.jpg" alt="image"></p>
                <hr>
